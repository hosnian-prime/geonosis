...
client. The quickstart `acme-web` client is registered with
...
`http://localhost:8080/admin-next/realms/acme/clients`.)

## Trying it

1. Open `http://127.0.0.1:8888`.
2. Click "Sign in with Geonosis".
3. Sign in as `ada@acme.test` / `ada-pw`.
